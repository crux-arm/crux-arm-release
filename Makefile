...
PORTS_STAGE0 = automake bash binutils coreutils dash diffutils file filesystem findutils gawk \
	gettext gcc grep glibc gzip libtool m4 make patch perl pkgconf pkgutils prt-get python3 sed tar
